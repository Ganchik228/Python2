...
for good_name, good_code in goods.items():
    good_total_cost = 0
    for good_item in store[good_code]:
        good_total_cost += good_item['quantity'] * good_item['price']
    total_cost[good_name] = good_total_cost

for good_name, good_cost in total_cost.items():
    print(f"{good_name} - {store[goods[good_name]][0]['quantity']} шт, стоимость {good_cost} руб")